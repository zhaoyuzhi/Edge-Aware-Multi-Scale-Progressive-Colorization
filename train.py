...
# implement for "Edge-Aware Multi-Scale Progressive Colorization", ICASSP 2021
# https://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=9414764
...
if __name__ == "__main__":
    ...
    parser.add_argument('--lr', type = float, default = 2e-4, help = 'Adam: learning rate for G')
    ...
    # dataset
    parser.add_argument('--baseroot', type = str, default = './dataset/ILSVRC2012_train_rgb', help = 'color image baseroot')
